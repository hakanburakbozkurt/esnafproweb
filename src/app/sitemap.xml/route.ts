...
/**
 * Saf XML çıktısı — Next.js Metadata Route (app/sitemap.ts) React/script enjekte edebilir.
 * Bu route handler yalnızca string XML döndürür; layout veya UI bundle devreye girmez.
 */
