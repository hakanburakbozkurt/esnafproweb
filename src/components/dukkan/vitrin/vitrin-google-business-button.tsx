import { normalizeGoogleBusinessUrl } from "@/lib/dukkan/google-business-url";
import { cn } from "@/lib/utils/cn";

type VitrinGoogleBusinessButtonProps = {
  url: string;
  className?: string;
  compact?: boolean;
};

export function VitrinGoogleBusinessButton({
  url,
  className,
  compact = false,
}: VitrinGoogleBusinessButtonProps) {
  const href = normalizeGoogleBusinessUrl(url);
  if (!href) return null;
