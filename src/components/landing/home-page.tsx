    ...
    <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/80 backdrop-blur-md">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <ul className="flex items-center gap-8">
          <li>
            <a href="#ozellikler" className="hidden text-sm text-slate-500 transition-colors hover:text-emerald-600 sm:inline">
              Özellikler
            </a>
          </li>
          <li>
            <a href="#moduller" className="hidden text-sm text-slate-500 transition-colors hover:text-emerald-600 sm:inline">
              Modüller
            </a>
          </li>
          <li>
            <a href="/fiyatlandirma" className="hidden text-sm text-slate-500 transition-colors hover:text-emerald-600 sm:inline">
              Fiyatlandırma
            </a>
          </li>
          <li>
    ...
    <footer className="border-t border-slate-100 px-6 py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 sm:flex-row">
        <p className="text-sm text-slate-400">
          © {new Date().getFullYear()} EsnafPRO. Tüm hakları saklıdır.
        </p>
