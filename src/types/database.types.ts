    ...
    Tables: {
      ...
      second_hand_devices: {
        Row: {
          ...
          hdd: string | null;
          icloud_signed_out: boolean | null;
          id: string;
          image_urls: string[] | null;
          imei: string | null;
...
export type SecondHandDevice =
  Database["public"]["Tables"]["second_hand_devices"]["Row"];
export type SecondHandDeviceInsert =
  Database["public"]["Tables"]["second_hand_devices"]["Insert"];
